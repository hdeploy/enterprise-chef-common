...
node.default['runit']['sv_bin']       = "#{install_path}/embedded/bin/sv"
node.default['runit']['svlogd_bin']   = "#{install_path}/embedded/bin/svlogd"
node.default['runit']['chpst_bin']    = "#{install_path}/embedded/bin/chpst"
node.default['runit']['service_dir']  = "#{install_path}/service"
node.default['runit']['sv_dir']       = "#{install_path}/sv"
node.default['runit']['lsb_init_dir'] = "#{install_path}/init"
